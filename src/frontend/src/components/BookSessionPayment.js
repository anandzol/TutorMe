...
const stripePromise = loadStripe("pk_test_51JEzYXFZbrhOEnTQW3KMOG6AmANtpuFPR1RuBUolSU46Q8FbWCgoGcX21ypLKHZaPhonf4ka6S6ypwcz94s60cjE00Yoh2TSFS");
        ...
        {paymentCompleted ? successMessage() : <React.Fragment>
          ...
          <div className="col-md-7">
            <Elements stripe={stripePromise}>
              <CheckoutForm state = { props } amount={totalAmount} setPaymentCompleted={setPaymentCompleted} />
            </Elements>
          </div>
        </React.Fragment>}
      </div>
